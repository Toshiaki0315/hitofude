...
| [ ] | 2-12 | **日本語 IME 実機確認**（R2 の早期検証） | §11 R2。**自動化不能・要手動**。日本語入力で実際に変換しながら打つ必要があり、開発者本人の確認が要る |
...
| Phase 2 エディタ装飾 | 10/11 | 2-12（IME 実機確認）のみ手動待ち。2-8 は ADR-0002 で削除 |
| Phase 3 入力補助 | 0/6 | **次はここ** |
| Phase 4 ファイル層 | 0/9 | |
| Phase 5 アプリ UI | 0/8 | |
| Phase 6 仕上げ・配布 | 0/8 | |
