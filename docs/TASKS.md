...
| [ ] | C-10   | **`[[ノート名]]` でのノート間リンクとバックリンク** ノートを繋いで使う道具にする                                                                                                                                 | **仕様書の範囲外で、規模も大きい。** やるなら単独のフェーズとして扱う                                                                       | 大   |
...
| [ ] | E-6    | **`[[ノート名]]` リンクとバックリンク**                                      | C-10 と同じもの。ノートを繋いで使うなら本命                                                                                        | 大   |
...
| これから C（C-1〜C-10） | 9/10  | 残るは C-10（`[[リンク]]`。E-6 と同じもの）          |
| これから D（D-1〜D-2）  | 2/2   | 完了。仕様書 §5.2 の積み残しを解消                  |
| これから E（E-1〜E-6）  | 4/6   | 残るは E-5 / E-6                                     |
