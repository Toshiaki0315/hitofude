...
| [~] | A-4    | **手動テストの通し実施** 151 件のうち **110 件は自動テストで担保**（`[a]` 印。根拠のテストを期待欄に書いた）。**残り 41 件が人の目で見るもの** | 内訳: 見え方（ダーク・余白・行の高さ）26、IME 3、外部エディタ 5、貼り付け 2、印刷 2、配布 3。配布は Developer ID 待ち                                                                                                                                              | 実機                                                              |      |
