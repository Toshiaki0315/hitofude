...
| [~] | E-6    | **`[[ノート名]]` リンクとバックリンク**（旧 C-10 を統合） ①リンクと `Cmd+クリック`（完了）②索引の `links` ③本文の下のバックリンク | 名前で結ぶ・無ければ作る・バックリンクは本文の下（ADR-0011）。①だけでも「繋いで飛べる」が手に入る                                                                                                     | 大   |
...
| これから E（E-1〜E-6）  | 4/6   | E-6 に着手（3 段の 1 段目）。残るは E-5              |
