...
| [ ] | `- ` と `* ` で箇条書きを書く                               | どちらも同じ点で出る（記号は出ない）                                                                       |
| [ ] | Tab で 3 段まで入れ子にする                                 | ● → ○ → ■ と形が変わる                                                                                     |
| [ ] | 箇条書きの行にカーソルを入れる                              | 生の `-` が戻り、そのまま直せる                                                                            |
| [ ] | `1. ` で番号付きを書く                                      | 数字はそのまま（点にならない）                                                                             |
...
| [ ] | `Cmd+6` を押す                                              | 本文の右にアシスタントの欄が出る                                                                           |
| [ ] | Ollama を止めた状態で開く                                   | ボタンが押せず、入れ方の案内が出る                                                                         |
| [ ] | ノートを開いて「要約」                                      | 数秒後から文字が流れ、答えが出る                                                                           |
| [ ] | 流れている途中で「止める」                                  | そこで止まり、書きかけは残る                                                                               |
| [ ] | 答えが出たあと本文を見る                                    | **本文は変わっていない**                                                                                   |
| [ ] | タグを付けたノートで「関連」                                | 同じタグのノートが理由付きで並ぶ                                                                           |
| [ ] | Ollama を止めて「関連」                                     | **押せる**（索引だけで出る）                                                                               |
| [ ] | 並んだノートを押す                                          | そのノートが開き、一覧もそこへ動く                                                                         |
| [ ] | 関係が無いノートで「関連」                                  | 「関連するノートはありません」と出る                                                                       |
| [ ] | 質問の欄に打って Enter                                      | 出典が先に出て、そのあと答えが流れる                                                                       |
| [ ] | 同じ題名のノートを 2 つ作って質問する                       | 出典に置き場所が添えられ、見分けが付く                                                                     |
| [ ] | 出典のノートを押す                                          | そのノートが開く                                                                                           |
| [ ] | ノートに無いことを聞く                                      | 「書かれていません」と答える                                                                               |
| [ ] | `#タグ` を付けて質問する                                    | そのタグのノートだけが出典になる                                                                           |
| [ ] | 当たらない言葉で質問する                                    | 「見つかりませんでした」と出て、待たされない                                                               |
| [ ] | 設定を開いて「LLM のモデル」を見る                          | 入っているモデルが候補に出る                                                                               |
| [ ] | 別のモデルを選んで OK                                       | 次の要約からそのモデルで動く                                                                               |
| [ ] | 設定を開く                                                  | 「一般」「アシスタント」の 2 ページに分かれている                                                          |
| [ ] | 「ポート」の横を見る                                        | 「送り先は 127.0.0.1 に固定」と出ている                                                                    |
